...
class WebsitePriceFilter(WebsiteSale):
   ...
   def _get_search_domain(self, search, category, attrib_values):
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        # User valuesp
        print(post,post.get("currency_symbol"),"gfgfuygf",self)
        print("re",request.website.get_current_pricelist().currency_id.rate)
